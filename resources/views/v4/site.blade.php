...
<meta property="og:url" content="{{ route('v4.site') }}">
@endsection

@section('style')
@parent
<link rel="stylesheet" href="{{ asset('v4/css/site.css') }}">
@endsection
...
@section('script')
    ...
    <script src="{{ asset('v4/js/site.js') }}"></script>
@endsection

@section('body-attributes', 'data-spy="scroll" data-target="#sidebar" data-offset="30"')
@section('body')
    @if (isset($msg))
    <style>#msg { height: 2em; line-height: 2em; text-align: center; font-size: 0.9em; color: #fff; background: rgba(73,155,234,1); margin-bottom: 1em; }</style>
    <div id="msg"><?=$msg;?></div>
    @endif
