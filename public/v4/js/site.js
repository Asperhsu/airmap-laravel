...
/***/ (function(module, exports, __webpack_require__) {
	...
	function genTable(title, data) {
		...
		return ['<div class="col-sm-12 col-md-6">', '<div class="panel panel-info">', '<div class="panel-heading">', title, '</div>', '<table class="table table-striped"><tbody>', tbody, '</tbody></table>', '</div>', '</div>'].join('');
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MapHandler = function () {
		...
		var registerBoundsChanged = function registerBoundsChanged() {
			googleApi.event.addListener(instance, 'bounds_changed', function () {
				var status = 'larger';
				var newBounds = instance.getBounds().toJSON();
	
				if (newBounds.east < bounds.east && newBounds.east < bounds.east && newBounds.east < bounds.east && newBounds.east < bounds.east) {
					status = 'smaller';
				}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SVGTool = __webpack_require__(7);
	...
	Site.prototype.fetchLastest = function (group, id) {
		...
		var includeRaw = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
